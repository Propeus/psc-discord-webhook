...
Instanciar e enviar mensagem completo
```powershell
Import-Module "psc-discord-webhook.psd1" -Force -Global
$metadata = New-DiscordMetadata -url_webhook $wh
$message= $metadata.GoMessage();
...
Instanciar e enviar mensagem completo concatenado funções
```powershell
Import-Module "psc-discord-webhook.psd1" -Force -Global
$metadata = New-DiscordMetadata -url_webhook $wh
...
Instanciar e enviar mensagem completo (Envia varias mensagens exibindo cada propriedade)
```powershell
Import-Module "psc-discord-webhook.psd1" -Force -Global
$metadata = New-DiscordMetadata -url_webhook $wh
$message= $metadata.GoMessage();
